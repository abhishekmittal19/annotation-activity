      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">
            Deep-dive operational metrics, reviewer agreement heatmaps, and
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <div className="p-5 rounded-xl bg-slate-900/80 border border-slate-800 space-y-2">
          ...
          <p className="text-2xl font-extrabold text-slate-100">
            {MOCK_METRICS.completedCount.toLocaleString()}
          </p>
        ...
        <div className="p-5 rounded-xl bg-slate-900/80 border border-slate-800 space-y-2">
          ...
          <p className="text-2xl font-extrabold text-cyan-300">
            {MOCK_METRICS.avgAnnotationTimeMinutes}m
          </p>
          <p className="text-xs text-slate-400">
            MTTR Review: {MOCK_METRICS.avgReviewTimeMinutes}m
          </p>
        </div>
      </div>
