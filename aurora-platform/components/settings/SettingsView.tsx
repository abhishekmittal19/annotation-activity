...
export function SettingsView() {
  ...
  const [activeTab, setActiveTab] = useState<
    "profile" | "notifications" | "workspace"
  >("profile");
    ...
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <p className="text-xs text-slate-400 mt-1">
          Configure authentication, notification alerts, and annotation
          workspace defaults.
        </p>
      </div>

      {/* Tabs */}
      <div className="flex border-b border-slate-800 gap-2 sm:gap-4 text-xs font-semibold overflow-x-auto min-w-0 flex-nowrap sm:flex-wrap pb-0.5">
        <button
          ...
          <div className="space-y-3 text-xs">
            <label className="flex items-center gap-2 text-slate-300 cursor-pointer">
              <input
                type="checkbox"
                defaultChecked
                className="rounded bg-slate-950 border-slate-700 text-cyan-600"
              />
            ...
            <label className="flex items-center gap-2 text-slate-300 cursor-pointer">
              ...
              />
              <span>
                Instant toast notification on QA rejection / rework request
              </span>
            </label>
            <label className="flex items-center gap-2 text-slate-300 cursor-pointer">
              <input
